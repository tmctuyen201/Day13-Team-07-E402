...
async def chat(request: Request, body: ChatRequest) -> ChatResponse:
    ...
    try:
        ...
        # Flush traces immediately to Langfuse
        if langfuse_client:
            log.info("sending_log_start", service="langfuse", payload={"action": "flush_traces_api"})
            langfuse_client.flush()
            log.info("sending_log_end", service="langfuse", payload={"action": "flush_traces_api"})
